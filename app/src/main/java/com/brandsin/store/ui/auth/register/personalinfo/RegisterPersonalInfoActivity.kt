...
{
    lateinit var binding : ActivityRegisterPersonalInfoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        viewModel = ViewModelProvider(this).get(RegisterPersonalInfoViewModel::class.java)
            ...
            intent.hasExtra(Params.USER_REGISTER) -> {
                when {
                    intent.getSerializableExtra(Params.USER_REGISTER) != null -> {
                        val userData: UserRegister = intent.extras!!.getSerializable(Params.USER_REGISTER) as UserRegister
