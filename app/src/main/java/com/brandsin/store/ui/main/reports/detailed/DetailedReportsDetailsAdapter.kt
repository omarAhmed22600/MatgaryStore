...
class DetailedReportsDetailsAdapter :
    RecyclerView.Adapter<DetailedReportsDetailsAdapter.ReportsDetailsHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReportsDetailsHolder {
        ...
        val binding: RawDetailedReportDetailsBinding = DataBindingUtil.inflate(
            layoutInflater,
            R.layout.raw_detailed_report_details,
            parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: ReportsDetailsHolder, position: Int) {
        ...
        if (position == 0) {
            holder.binding.tvOrdersCount.setTextColor(
                ContextCompat.getColor(
                    MyApp.getInstance(),
                    R.color.black
                )
            )
            holder.binding.tvOrdersCost.setTextColor(
                ContextCompat.getColor(
                    MyApp.getInstance(),
                    R.color.black
                )
    ...
    inner class ReportsDetailsHolder(val binding: RawDetailedReportDetailsBinding) :
