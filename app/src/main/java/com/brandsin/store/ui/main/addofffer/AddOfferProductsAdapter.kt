...
class AddOfferProductsAdapter : RecyclerView.Adapter<AddOfferProductsAdapter.OfferProductsHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OfferProductsHolder {
        ...
        val binding: RawOfferProductsBinding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_offer_products, parent, false)
    ...
    inner class OfferProductsHolder(val binding: RawOfferProductsBinding) : RecyclerView.ViewHolder(binding.root)
