...
class ApiRepo(private val apiInterface: ApiInterface) {
    ...
    suspend fun getStoreOrders(lang : String , userId : Int , limit : Int , status : String , page : Int) = apiInterface.getStoreOrders(lang, userId , limit , status , page)
    ...
    suspend fun setUpdateStatusOrder(request: UpdateStatusOrderRequest) = apiInterface.setUpdateStatusOrder(request)
    ...
    suspend fun updateOfferWithoutImage(request : UpdateOfferRequest) = apiInterface.updateOfferWithoutImage(request)
    ...
    suspend fun getStoreProducts(storeId : Int , locale : String, page : Int , limit : Int) = apiInterface.getStoreProducts(storeId , locale , page, limit)
    ...
    suspend fun getProductCategories(parentsOnly : Int, lang : String, storeId : Int) = apiInterface.getProductCategories(parentsOnly , lang , storeId)
    ...
    suspend fun setOfferAddProduct(request : OfferAddProductRequest) = apiInterface.setOfferAddProduct(request)

    suspend fun getReportsTotal(store_id : Int,limit : Int,page : Int,type : String,from : String, to : String) = apiInterface.getReportsTotal(store_id, limit, page, type, from, to)

    suspend fun getReportsDetails(store_id : Int,limit : Int,page : Int,type : String,from : String, to : String) = apiInterface.getReportsDetails(store_id, limit, page, type, from, to)

    suspend fun getUnitsList(categories: ArrayList<Int>,locale: String) = apiInterface.getUnitsList(categories,locale)
    ...
    suspend fun uploadStories(request : UploadStoryRequest) = apiInterface.uploadStories(
        request.storeId!!.toRequestBodyParam(),
        request.text!!.toRequestBodyParam(),
        request.file?.toMultiPartV("file")!!
    )

    suspend fun uploadStoriesWithout(request: UploadStoryWithoutRequest) = apiInterface.uploadStoriesWithout(request)
}